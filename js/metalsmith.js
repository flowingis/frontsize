...
$(function() {
    ...
    function applyToIFrame($iframe) {
        ...
        if (setting.background !== 'transparent') {
            $iframe.closest('.layout-wrapper__grid').removeClass('layout-wrapper__grid--transparent').css('background-color', setting.background)
        } else {
            $iframe.closest('.layout-wrapper__grid').addClass('layout-wrapper__grid--transparent').attr('style', '')
        }
        setTimeout(function() {
